...
public class DatabaseHelperServer2 extends SQLiteOpenHelper {

    public static final String DATABASE_NAME ="vehicleService2.db";

    public static final String TABLE_MAIN ="main";
    private static final String COLUMN_Auto = "auto";
    //private static final String COLUMN_AutoOff = "ac";
    ...
    private String MAIN_DATA_TABLE = "CREATE TABLE main(main_id INTEGER PRIMARY KEY AUTOINCREMENT,auto TEXT)";
    ...
    public DatabaseHelperServer2(Context context) {
    ...
    public boolean insertAutoData(String auto){
        SQLiteDatabase db=this.getWritableDatabase();

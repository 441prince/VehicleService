...
public class DatabaseHelperServer extends SQLiteOpenHelper {

    public static final String DATABASE_NAME ="vehicleService.db";

    public static final String TABLE_MAIN ="main";
    private static final String COLUMN_AutoOn = "autoOn";
    private static final String COLUMN_AutoOff = "autoOff";
    ...
    private String MAIN_DATA_TABLE = "CREATE TABLE main(main_id INTEGER PRIMARY KEY AUTOINCREMENT,autoOn TEXT,autoOff TEXT)";
    ...
    public DatabaseHelperServer(Context context) {
    ...
    public boolean insertMainData(DatabaseServer databaseServer){
        SQLiteDatabase db=this.getWritableDatabase();
        ContentValues contentValues=new ContentValues();
        contentValues.put(COLUMN_AutoOn ,databaseServer.getAutoButtonOn());
        contentValues.put(COLUMN_AutoOff,databaseServer.getAutoButtonOff());
